...
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecord> {
    ...
    // Create a default kafka producer factory using the above producer config
    @Bean
    ...
    // Create a kafka template that will be used
    // as a template to send data to the kafka cluster
    @Bean
