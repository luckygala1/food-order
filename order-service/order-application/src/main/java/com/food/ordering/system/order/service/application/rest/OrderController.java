...
public class OrderController {
    ...
    public ResponseEntity<TrackingOrderResponse> getOrderByTrackingId(@PathVariable UUID trackingId){
        ...
        TrackingOrderResponse trackingOrderResponse = orderApplicationService.trackOrder(TrackOrderQuery.builder().orderTrackingId(trackingId).build());
        log.info("Order tracked successfully with tracking id: {} and has status: {}",trackingOrderResponse.getOrderTrackingId(),trackingOrderResponse.getOrderStatus());
